    ...
    <section id="languages" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6 md:px-12 max-w-5xl relative z-10">
        ...
        <div className="flex flex-col items-center mb-16 text-center">
          <span className="text-cyan-400 font-mono text-sm tracking-widest uppercase mb-3 font-bold">System Protocols</span>
            ...
            {portfolioData.languages.map((lang, index) => (
              ...
              >
                ...
                >
                  ...
                  <span className="font-mono text-xl font-bold text-gray-200 group-hover:text-cyan-400 transition-colors z-10">{lang.name.substring(0,2).toUpperCase()}</span>
                </motion.div>
                
                <h4 className="text-lg font-bold text-white mb-1">{lang.name}</h4>
                <p className="text-xs font-mono font-bold text-cyan-400">{lang.level}</p>
              </motion.div>
            ))}
          </div>
        ) : (
